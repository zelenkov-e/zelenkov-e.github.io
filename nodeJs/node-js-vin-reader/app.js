...
// const img = require("../node-js-captcha-solver/img.jpeg");
...
app.post("/captcha-solver", async (request, response) => {
  ...
  // if (svg) {
  //   // const outputFilePath = await convertFile(svg);
  ...
  //   // const image = await solver.getBase64Encoded(outputFilePath);
  //   // use local image
  //   // const localImage = await solver.getBase64LocalCaptcha("../node-js-captcha-solver/img.jpeg");
  //   const localImage = await solver.getBase64LocalCaptcha("../node-js-captcha-solver/img.jpeg");
