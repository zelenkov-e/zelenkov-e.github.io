...
/***/ (function(module, exports, __webpack_require__) {
	      ...
	      return this.props.phones.map(function (phone) {
	        return _react2.default.createElement(
	          ...
	          { onClick: function onClick() {
	              return _this2.props.select(phone);
	            },
	            key: phone.id },
	          phone.model
	        );
	...
	var matchDispatchToProps = function matchDispatchToProps(dispatch) {
	  return (0, _redux.bindActionCreators)({ select: _index.selectPhone }, dispatch);
	};

	exports.default = (0, _reactRedux.connect)(mapStateProps, matchDispatchToProps)(List);
...
/***/ (function(module, exports) {
	...
	//action creater
	var selectPhone = exports.selectPhone = function selectPhone(phone) {
...
/***/ (function(module, exports, __webpack_require__) {
			...
			value: function render() {
				...
				return _react2.default.createElement(
					...
					_react2.default.createElement(
						...
						null,
						'cost:',
						this.props.phone.cost,
						' \u0440\u0443\u0431 '
					),
					_react2.default.createElement('img', { src: this.props.phone.img })
				);
			}
		}]);
	...
	exports.default = (0, _reactRedux.connect)(mapStateProps)(Details);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _phone_active = __webpack_require__(74);

	var _phone_active2 = _interopRequireDefault(_phone_active);

	function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

	var rootReducer = (0, _redux.combineReducers)({
	  phones: _info2.default,
	  active: _phone_active2.default
