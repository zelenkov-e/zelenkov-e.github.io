...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _details = __webpack_require__(28);
	...
	var pageActions = _interopRequireWildcard(_index);
	...
	var Content = function (_React$Component) {
	  ...
	  _createClass(Content, [{
	    ...
	    value: function render() {
	      var weatherElements = this.props.weatherElements;
	      var weatherMain = this.props.weatherMain;
	      var weatherTemp = this.props.weatherTemp;
	      var getWeather = this.props.pageActions.getWeather;

	      return _react2.default.createElement(
	        'div',
	        null,
	        _react2.default.createElement(_details2.default, { weatherMain: weatherMain,
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var Details = function (_React$Component) {
	  ...
	  _createClass(Details, [{
	    key: 'onWeatherBtnClick',
	    value: function onWeatherBtnClick(e) {
	    ...
	    value: function render() {
	      ...
	      return _react2.default.createElement(
	        ...
	        _react2.default.createElement(
	          'button',
	          {
	            onClick: this.onWeatherBtnClick.bind(this) },
	          'show Weather'
	        ),
	        ...
	        _react2.default.createElement(
	          'h3',
	          null,
	          weatherElements.name
	        ),
	        weatherMain.map(function (weather) {
	          return _react2.default.createElement(
	            'p',
	            { key: weather.id },
	            weather.main
	        ...
	        weatherMain.map(function (weather) {
	          var url1 = 'https://openweathermap.org/img/w/';
	          var url2 = '.png';
	          return _react2.default.createElement('img', { key: weather.id, src: url1 + weather.icon + url2 });
	        }),
	        _react2.default.createElement(
	          'p',
	          null,
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _compose = __webpack_require__(49);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _connectAdvanced = __webpack_require__(57);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _Subscription = __webpack_require__(60);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _mapDispatchToProps = __webpack_require__(63);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _wrapMapToProps = __webpack_require__(64);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _verifyPlainObject = __webpack_require__(65);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	function getWeather(res) {
	  ...
	  return function (dispatch) {
	    dispatch({
	      type: _info.GET_WEATHER_REQUEST
	    });

	    _axios2.default.get(_info.URL).then(function (res) {
	      return dispatch({
	        //создаем несколько payload что бы дотянуться до каждого объекта масссива res.data
	        type: _info.GET_WEATHER_SUCCESS,
...
/***/ (function(module, exports) {
	...
	var URL = exports.URL = 'https://api.openweathermap.org/data/2.5/weather?id=620127&units=metric&cnt=5&APPID=1ef962a01bb852fda0e833c7385144ba';
...
/***/ (function(module, exports, __webpack_require__) {
	...
	function configureStore(initialState) {
		...
		(0, _redux.applyMiddleware)(_reduxThunk2.default, logger)); // <-- добавили его в цепочку перед logger'ом
		return store;
	}
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _infoMain = __webpack_require__(100);

	var _infoMain2 = _interopRequireDefault(_infoMain);

	var _infoElements = __webpack_require__(101);

	var _infoElements2 = _interopRequireDefault(_infoElements);

	var _infoTemp = __webpack_require__(102);

	var _infoTemp2 = _interopRequireDefault(_infoTemp);

	function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

	var redusers = (0, _redux.combineReducers)({
	   //нужно на каждое обращение к объекту,массиву res.data   - свой редюсер
	   weatherElements: _infoElements2.default,
	   weatherMain: _infoMain2.default,
	   weatherTemp: _infoTemp2.default
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var weatherReduserMain = function weatherReduserMain() {
	  var state = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : initialState;
	  var action = arguments[1];

	  switch (action.type) {
	    case _info.GET_WEATHER_REQUEST:
	      return state;

	    case _info.GET_WEATHER_SUCCESS:
	...
	exports.default = weatherReduserMain;
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var weatherReduserElements = function weatherReduserElements() {
	  var state = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : initialState;
	  var action = arguments[1];
	...
	exports.default = weatherReduserElements;
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var weatherReduserTemp = function weatherReduserTemp() {
	  var state = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : initialState;
	  var action = arguments[1];
	...
	exports.default = weatherReduserTemp;
